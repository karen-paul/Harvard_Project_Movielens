...
Method : After examining the data we need to come up with the best approach to create this model. The final hold-out test set has only been used for validating the final model. Till then we use 20% of edx data set as the test set. 
